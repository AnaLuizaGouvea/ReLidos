...
import com.example.relidos.Model.BrandModel
import com.example.relidos.R
import com.example.relidos.databinding.ActivityMainBinding
import com.example.relidos.databinding.ViewholderBrandBinding
import com.example.relidos.databinding.ViewholderColorBinding
...
class SizeAdapter(val items:MutableList<String>):
    ...
    override fun onBindViewHolder(holder: SizeAdapter.Viewholder, position: Int) {
        ...
        if(selectedPosition==position){
            ...
            holder.binding.sizeText.setTextColor(context.resources.getColor(R.color.darkGreen))
